...
const UnsubscribedMembers: React.FC = () => {
  const unsubscribedMembers = membersList.filter(member => !member.subscribed);
  const [data, setData] = useState(unsubscribedMembers);
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <Title level={2}>Unsubscribed Members</Title>
      ...
      >
        <Form form={form} layout="vertical" name="member_form">
          ...
          <Form.Item name="package" label="Previous Package">
...
export default UnsubscribedMembers;
